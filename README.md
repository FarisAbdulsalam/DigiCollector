...
- User authentication
- Create, edit, and delete cards in your collection
- Commenting system
- View all collections submitted by other users

## Technologies Used

EJS, Bootstrap, Express, MongoDB, bcrypt

## Next Steps

- Public user profiles
- Sort & filter cards in card collection
- Upload card images